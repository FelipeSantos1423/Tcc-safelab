...
<body class="min-h-screen flex flex-col">
    ...
    <header class="bg-blue-700 text-white sticky top-0 z-50">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-blue-800 pb-4 px-4">
            <ul class="flex flex-col space-y-3">
                ...
                <li><a href="#login" class="block py-2 hover:bg-blue-700 px-4 rounded">Login</a></li>
    ...
    <main class="flex-grow">
        ...
        <section class="gradient-bg text-white py-12 md:py-20">
            <div class="container mx-auto px-4 flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-10 md:mb-0">
                    ...
                    <a href="#login" class="bg-white text-blue-600 font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition duration-300 inline-block">
                        Acessar o sistema
                    </a>
                </div>
        ...
        <!-- Login Section -->
        <section id="login" class="py-12 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="max-w-md mx-auto bg-white p-8 rounded-lg card-shadow">
                    <h2 class="text-2xl font-bold text-center mb-6 text-gray-800">Acesso ao sistema</h2>
                    <form id="loginForm" class="space-y-6">
                        ...
                        <button type="submit" 
                                class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Entrar
                        </button>
                    </form>
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">Não tem uma conta? <a href="#" class="text-blue-600 hover:underline">Solicite acesso</a></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="text-center md:text-right">
                    ...
                    <p class="text-gray-400">Orientadores: Prof. Dr. Silva & Profa. Dra. Oliveira</p>
                    <p class="text-gray-400">Universidade Federal de Tecnologia</p>
                </div>
            </div>
