...
<a class="text-sm font-medium text-gray-300 hover:text-primary transition-colors" href="public/dashboard.php">Dados</a>
</nav>
...
<a class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-primary/20" href="public/dashboard.php">Dados</a>
</nav>
</div>
</header>
<!-- ======= FIM NAVBAR ======= -->
...
<a class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em] hover:bg-primary/90" href="public/dashboard.php">
<span class="truncate">Visualizar Dados</span>
</a>
</div>
</div>
</section>
