...
<a class="inline-block bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-bold py-3 px-8 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors" href="public/dashboard.php" id="dashboard">Ver Dashboard</a>
</div>
</div>
</section>
