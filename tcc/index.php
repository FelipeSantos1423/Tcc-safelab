...
<a class="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors" href="#dashboard">Dashboard</a>
</nav>
...
<a class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-200 hover:text-white hover:bg-primary" href="#dashboard">Dashboard</a>
</nav>
</div>
</header>
...
<a class="inline-block bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-bold py-3 px-8 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors" href="#" id="dashboard">Ver Dashboard</a>
</div>
</div>
</section>
...
<a class="text-xs text-gray-500 dark:text-gray-400 hover:text-primary mt-2 inline-block" href="#">Login do Administrador</a> <!--Caminho login do adm -->
</div>
</div>
</footer>
</div>
